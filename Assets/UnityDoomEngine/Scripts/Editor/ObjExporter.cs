...
// modified by Risto Paasivirta (get material name from texture)
...
public class ObjExporterScript
{
    ...
    public static string MeshToString(MeshFilter mf, Transform t)
    {
        ...
        {
            #region Modified by Risto Paasivirta
            //get material name from the texture used
            ...
            if (mr != null)
            {
                ...
                if (properties != null)
                    tex = properties.GetTexture("_MainTex");
            }
            ...
            if (tex != null)
            {
                sb.Append("usemtl ").Append(tex.name).Append("\n");
                sb.Append("usemap ").Append(tex.name).Append("\n");
            }
            else
            {
